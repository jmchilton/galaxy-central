...
if [ -n "$migrated_test" ] ; then
    ...
    # Use to ensure specific versions of casperjs and phantomjs were
    # available, the implementation of these checks were unpopular so
    # removed. But some sort check or option for automatically
    # installing these dependencies would be nice.
