...
Ideally, the actual classes could be refactored to have fewer dependencies
allowing this these centralized test fixtures can go away. This module itself
is somewhat of anti-pattern causing all sorts of unfortunate interdepdencies
between very different tests."""
