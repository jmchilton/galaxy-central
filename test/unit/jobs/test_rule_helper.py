...
def test_should_burst( ):
    ...
    assert rule_helper.should_burst( [ "cluster1" ], "10" )
    assert not rule_helper.should_burst( [ "cluster1" ], "5" )

    assert rule_helper.should_burst( [ "cluster1" ], "5", job_states="queued" )
    assert not rule_helper.should_burst( [ "cluster1" ], "2", job_states="queued" )
