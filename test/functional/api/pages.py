...
class PageApiTestCase( api.ApiTestCase ):
    ...
    def test_index( self ):
        ...
        assert create_response_json[ "id" ] in map( itemgetter( "id" ), pages )
    ...
    def test_index_doesnt_show_unavailable_pages( self ):
        ...
        self._assert_status_code_is( index_response, 200 )
        pages = index_response.json()
        assert create_response_json[ "id" ] not in map( itemgetter( "id" ), pages )
    ...
    def test_cannot_create_pages_with_same_slug( self ):
        ...
        self.assertEquals(page_response_2.status_code, 400)
    ...
    def test_404_on_delete_unknown_page( self ):
        response = delete_request( self._api_url( "pages/%s" % self._random_key(), use_key=True ) )
    ...
    def test_403_on_delete_unowned_page( self ):
        ...
        response = delete_request( self._api_url( "pages/%s" % page_response[ "id" ], use_key=True ) )
