...
try:
    ...
    def post_request( url, data, files={} ):
        __multipart_request( url, data, files, verb="POST" )

    def put_request( url, data, files={} ):
        __multipart_request( url, data, files, verb="PUT" )

    def delete_requrest( url ):
        __multipart_request( url, data={}, files={}, verb="DELETE" )
