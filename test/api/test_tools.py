...
class ToolsTestCase( api.ApiTestCase ):
    ...
    def test_map_over_collection_output( self ):
        ...
        pair00, pair01 = element0["object"]["elements"]
        pair10, pair11 = element1["object"]["elements"]

        pair_ids = []
        for pair in pair00, pair01, pair10, pair11:
            assert "object" in pair
            assert "collection_type" in pair
            assert pair["collection_type"] == "paired"
            pair_ids.append(pair["object"]["id"])
