...
class Tool( object, Dictifiable ):
    ...
    def __handle_tool_executions( self, execution_tracker, trans, rerun_remap_job_id, history ):
        """ Run through each combination of parameters that result from the
        call and record successes and failures.
        """
    ...
    def __expand_meta_properties( self, trans, incoming ):
        """
