...
def __api_error_message( trans, **kwds ):
    ...
    if trans.app.debug:  # TODO: Should admins get to see traceback as well?
        error_response[ "traceback" ] = traceback_string
    return error_response


def __api_error_response( trans, **kwds ):
    error_response = __api_error_response( trans, **kwds )
    exception = kwds.get( "exception", None )
    ...
    return simplejson.dumps( error_response )
