        ...
        if( collection_type == "list" ) {
            this.chain().each( function( hda ) {
                ...
                if( content_type == "dataset" ) {
                    ...
                    element_identifiers[ name ] = { "src": "hda", "id": id };
                } else {
                    if( full_collection_type == "list" ) {
                    ...
                    element_identifiers[ name ] = { "src": "hdca", "id": id };
                }
            });
            ...
            element_identifiers[ "left" ] = { "src": "hda", "id": ids[ 0 ] };
            element_identifiers[ "right" ] = { "src": "hda", "id": ids[ 1 ] };
